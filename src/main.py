...
with install_import_hook(
    ...
    from src.model.encoder import get_encoder_depth_transformer, get_encoder_costvolume
    from src.model.model_wrapper import ModelWrapper
    from src.model.raft_gaussian_splat.core.raft import RAFT
...
def train(cfg_dict: DictConfig):
    ...
    trainer = Trainer(
        ...
        accelerator="gpu",
        logger=logger,
        devices=cfg.trainer.num_tasks_per_node,
    ...
    iterative_nvs_model = RAFT(cfg.model.encoder)

    model_kwargs = {
        "optimizer_cfg": cfg.optimizer,
        "test_cfg": cfg.test,
        "train_cfg": cfg.train,
        "encoder": iterative_nvs_model,
...
if __name__ == "__main__":
    ...
    print("Device Count: ", num_devices)
